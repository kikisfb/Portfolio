...
export const AboutSection=() =>
{
    ...
    <section id="about" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 max-w-5xl">
                About <span className="text-primary"> Me</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <h3 className="text-2xl font-semibold">A passionate software developer</h3>
                    <p className="text-muted-foreground">
                        With over 2 years of experience in full stack development, I especialize
                        in creating reponsive, accessible and performant web applications using modern technologies.
                    </p>
                    <p className="text-muted-foreground">
